...
const Education = () => {
  ...
  return (
    <section id="education" className="py-20 bg-white/5 dark:bg-dark-900/50">
          ...
          {education.map((edu, index) => (
            ...
            >
              ...
              <div className="flex items-start space-x-6">
                {/* Timeline Dot */}
                <div className={`flex-shrink-0 w-16 h-16 rounded-full bg-gradient-to-r ${edu.color} flex items-center justify-center shadow-lg`}>
                ...
                <div className="flex-1">
                  <div className="bg-white/10 dark:bg-gray-800/50 backdrop-blur-md rounded-2xl p-6 border border-white/20 dark:border-gray-700/50 hover:bg-white/20 dark:hover:bg-gray-700/50 transition-all duration-300">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                      ...
                      <div className="flex flex-col md:items-end text-sm text-gray-500 dark:text-gray-400 md:ml-4">
